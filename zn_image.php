...
class ZN_Image
{
	...
	public static function check($file, $width=0, $height=0)
	{
		...
		if(intval(trim($width)) != 0)
		{
			...
			{throw new Exception("Ширина \"{$width}\" задана неверно");}
			...
			if(!empty($sovpal[1]))
			{
				switch ($sovpal[1])
				{
					case ">":
					{
						...
						{throw new Exception("Ширина должна быть больше \"{$width}\".");}
					}
					break;
					...
					{
						if($settings['width'] < $width)
						{throw new Exception("Ширина должна быть больше, либо равна \"{$width}\".");}
					}
					break;
					...
					{
						if($settings['width'] >= $width)
						{throw new Exception("Ширина должна быть меньше \"{$width}\".");}
					}
					break;
					...
					{
						if($settings['width'] > $width)
						{throw new Exception("Ширина должна быть меньше, либо равна \"{$width}\".");}
					}
					break;
					...
					{
						if($settings['width'] != $width)
						{throw new Exception("Ширина должна быть равна \"{$width}\".");}
					}
					break;
				}
			}
			...
			if(!empty($sovpal[1]))
			{
				switch ($sovpal[1])
				{
					case ">":
					{
						...
						{throw new Exception("Высота должна быть больше \"{$height}\".");}
					}
					break;
					...
					{
						if($settings['height'] < $height)
						{throw new Exception("Высота должна быть больше, либо равна \"{$height}\".");}
					}
					break;
					...
					{
						if($settings['height'] >= $height)
						{throw new Exception("Высота должна быть меньше \"{$height}\".");}
					}
					break;
					...
					{
						if($settings['height'] > $height)
						{throw new Exception("Высота должна быть меньше, либо равна \"{$height}\".");}
					}
					break;
					...
					{
						if($settings['height'] != $height)
						{throw new Exception("Высота должна быть равна \"{$height}\".");}
					}
					break;
				}
			}
